...
const Header = () => {
    ...
    return (
        <header className={ `navbar  border-b-2 ${ isScrolled ? 'bg-white text-black border-primary' : 'bg-black/30 text-white  border-transparent'
            } h-20 font-semibold fixed z-10 transition-bg ease-in-out duration-300` }>
