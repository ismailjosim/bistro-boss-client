...
const Footer = () => {
  return (
    <footer>
      ...
      <div className="bg-[#151515] text-white text-center py-8">
        <div className="flex items-center justify-center gap-3 mb-4">
          <img src="/dineOS-only-logo.png" alt="DineOS" className="h-10 w-auto" />
          <span className="font-cinzel font-bold text-lg">DineOS</span>
        </div>
        <p>Copyright © DineOS Restaurant. All rights reserved.</p>
      </div>
    </footer>
  );
};
