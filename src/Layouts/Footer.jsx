...
const Footer = () => {
    return (
        <footer>
            <div className='flex'>
                <div className='hover:bg-[#1F2937] bg-[#111827] duration-200 ease-in-out transition-all text-white w-1/2 p-10 text-end'>
                ...
                <div className='hover:bg-[#1F2937] bg-[#111827] duration-200 ease-in-out transition-all text-white w-1/2 p-10 text-start'>
