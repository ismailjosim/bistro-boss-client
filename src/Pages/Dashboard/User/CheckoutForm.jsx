...
const CheckoutForm = ({ price, cart }) => {
	...
	const [, setConfirmCardError] = useState(null)
	...
	return (
		<>
			...
			{cardError && (
				<div className='alert alert-error text-white font-semibold mt-5'>
					<VscError />
			...
			{transactionId && (
				<div className='alert-success text-white font-semibold mt-5 flex items-center gap-2 p-2 rounded-md'>
