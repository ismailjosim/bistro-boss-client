            ...
            <div className="mx-auto h-full sm:w-max">
                <div className="m-auto py-12">
                    <div className="mt-12 rounded-md border bg-gray-50 border-gray-700 -mx-6 sm:-mx-10 p-8 sm:p-10">
                        ...
                        <form onSubmit={ handleUserLogin } className="mt-10 space-y-8 dark:text-white">
                            <div>
                        ...
                        <div className='flex justify-end mt-5'>
                            <Link to={ '/register' } state={ { from } } className="text-base text-neutral font-semibold hover:text-primary transition-all ease-in-out">Create new account</Link>
                        </div>
