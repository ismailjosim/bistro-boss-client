...
const ChefBio = ({ chefData }) => {
	const { avatar, name, age, details, experience, recipes, likes, myRecipes } =
		chefData
			...
			<div className='card-body flex gap-3'>
				...
				<div className='grid grid-cols-3'>
					...
					<div>
						<a
							...
							className='col-span-2 mb-0 hover:text-primary hover:underline transition-all duration-200'
							rel='noreferrer'
						>
							linkedin.com/in/ismailjosim
						</a>
					</div>
				</div>
				<hr />
				<div className='grid grid-cols-3'>
					...
					<div>
						<a
							target='_blank'
							href='https://drive.google.com/file/d/1outMVkz4ZmF902o7SotvWdR5n_h2iDEb/view?usp=share_link'
							className='col-span-2 mb-0 hover:text-primary hover:underline transition-all duration-200'
							rel='noreferrer'
						>
							My Resume
