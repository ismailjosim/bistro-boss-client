...
const Hero = () => {
  ...
  const properties = {
    prevArrow: (
      <button className="btn btn-primary text-white text-lg ml-5 absolute bottom-20">
        <AiFillCaretLeft />
      </button>
    ),
    nextArrow: (
      <button className="btn btn-primary text-white text-lg mr-5 absolute bottom-20">
        <AiFillCaretRight />
      </button>
    ),
  };
            ...
            <div className="relative mx-auto max-w-screen-xl px-4 py-32 sm:px-6 lg:flex lg:items-center lg:px-8">
              <div className="max-w-xl text-center sm:text-left text-white">
                ...
                <p className="mt-4 max-w-lg sm:text-xl sm:leading-relaxed">
                  Gets your taste buds a jolt of sweetness. Taste our candy and fall in love. The
                  candy store that will make you want more. Serving all the candies in town since
                  2020.
                </p>
                <div className="mt-8 flex justify-center lg:justify-start md:justify-start flex-wrap gap-4 text-center">
                  ...
                  <button className="btn btn-primary text-white flex gap-1">
                    <span>Order Now</span> <FaShoppingCart className="text-xl" />
                  </button>
                </div>
              </div>
            </div>
