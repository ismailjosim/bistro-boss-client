						...
						<div className='relative mx-auto max-w-screen-xl px-4 py-32 sm:px-6 lg:flex lg:items-center lg:px-8'>
							<div className='max-w-xl text-center sm:text-left text-white'>
								...
								<p className='mt-4 max-w-lg sm:text-xl sm:leading-relaxed'>
									Gets your taste buds a jolt of sweetness. Taste our candy and
									fall in love. The candy store that will make you want more.
									Serving all the candies in town since 2020.
								</p>
